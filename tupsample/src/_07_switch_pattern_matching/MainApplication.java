package _07_switch_pattern_matching;
...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        try{
            System.out.println("Transform to boolean: " + transformToBoolean("Maybe")); // IllegalArgumentException: Input has invalid value: Maybe
        } catch(IllegalArgumentException e){
            System.out.println("Illegal Transaction caught: " + e);
        }
